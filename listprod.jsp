...
try (Connection connection = DriverManager.getConnection(url, uid, pw); Statement stmt = connection.createStatement();) {
    ...
    if (name != "null") {
        ...
        out.println("<th>Action</th>");  // Added this line for the 'Add to Cart' link
        ...
        while (productResultSet.next()) {
            ...
            // 3. For each product create a link
            // product.jsp?id=productId
			out.println("<tr><td><a href='product.jsp?id=" + productId + "'>" + productName + "</a></td>");
                
            // 4. Add 'Add to Cart' link
            ...
            out.println("<td><a href='addcart.jsp?id=" + productId +
                ...
                "&price=" + productPrice + "'>Add to Cart</a></td></tr>");
        }
        ...
        PreparedStatement productStatement = connection.prepareStatement(productQuery);
        ResultSet productResultSet = productStatement.executeQuery(); // Remove (productQuery)
        ...
        while (productResultSet.next()) {
            ...
            out.println("<tr><td><a href='product.jsp?id=" + productId +
				"&name=" + URLEncoder.encode(productName, "UTF-8") +
				"&price=" + productPrice + "'>" + productName + "</a></td>");
